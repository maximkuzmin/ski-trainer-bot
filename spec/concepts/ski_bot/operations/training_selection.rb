# require 'spec_helper'
#
# describe SkiBot::TrainingSelection do
#   # TODO: make it work
#   let!(:api){ double(Telegram::Bot::Api, send_message: true) }
#   let!(:client){ instance_double(Telegram::Bot::Client, api: api) }
#   let!(:training_plan){ create :training_plan, title: Ryba::Company.name }
#   let(:user){ create(:user, age: 25, training_plan: training_plan) }
#   let(:text){ 'some text' }
